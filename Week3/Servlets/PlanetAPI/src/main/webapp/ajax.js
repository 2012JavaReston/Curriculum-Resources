 ...
 */
 ...
 window.onload = function(){
     document.getElementById("pokemonSubmit").addEventListener('click',getPlanet);
     console.log("setting the listener!")
 };

 function getPlanet(){
    //Getting the pokemon id form the user
    let planetId = document.getElementById("pokemonId").value;
     ...
     */
     ...
     let PlanetURL = "http://localhost:8080/PlanetAPI/api/Planet?planetId=";
     
     xhttp.open("GET",PlanetURL + planetId);
...
function DOMManipulation(planet){

    //setting the name
   document.getElementById("pokemonName").innerHTML = planet.name;
